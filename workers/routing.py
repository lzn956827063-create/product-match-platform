def execute_job(kind, ident):
    ...
    handlers={'quality':process_quality,'catalog_plan':process_plan,'match':process_run,'export':process_export,'import':process_import,'cleanup':process_cleanup,'shadow':process_shadow,'release_validate':process_validation,'release_files':process_files,'catalog_change':process_change,'delivery':process_delivery,'annotation_score':process_scores}
